...
/**
 * Test suite for the DestinationAdapter. This adapter is responsible for
 * displaying destinations in lists that request it.
 */
public class DestinationAdapterTest extends AndroidTestCase {
	...
	protected void setUp() throws Exception {
		...
		bollywood = new Destination("Bollywood", "I've always wanted to be in a musical", new Coordinate(18.975,
				72.8258));
