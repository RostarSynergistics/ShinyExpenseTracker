...
public class ESClaimManagerTest extends TestCase {
	...
	ExpenseItem item = new ExpenseItem("Flight to YEG", null,
			Category.AIR_FARE, BigDecimal.valueOf(1000), Currency.CAD);
	...
	protected void setUp() throws Exception {
		...
		claim = new ExpenseClaim("BC trip", sdate, edate, Status.IN_PROGRESS,
				tagList);
		...
		list.addClaim(claim);
		claim2 = new ExpenseClaim("AB Trip", null, null, Status.IN_PROGRESS,
				tagList);
