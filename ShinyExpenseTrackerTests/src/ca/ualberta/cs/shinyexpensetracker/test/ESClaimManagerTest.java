...
public class ESClaimManagerTest extends TestCase {
	...
	public void testAddClaim() throws IllegalStateException, IOException {
		...
		assertEquals(gottenList.getClaimAtPosition(0), claim);
		assertEquals(gottenList.getClaimAtPosition(1), claim2);
		...
		assertFalse(gottenList.getClaimAtPosition(0).equals(claim));

		assertEquals(gottenList.getClaimAtPosition(0), claim2);
		assertEquals(gottenList.getClaimAtPosition(1), claim);
	}
