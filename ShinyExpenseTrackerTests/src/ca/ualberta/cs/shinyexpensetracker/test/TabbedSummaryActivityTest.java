...
public class TabbedSummaryActivityTest extends
	...
	final ExpenseItem expense = new ExpenseItem("expenseItemName", new Date(1000), Category.ACCOMODATION, 
	...
	/**
	 * Test if a claim is marked as 'Incomplete' and the 'Submit Claim' menu item
	 * is selected that a dialog appears and that the claim's status is not changed 
	 */
